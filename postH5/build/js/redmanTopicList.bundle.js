...
module.exports = __webpack_require__.p + "assets/list-bg-2x-5b0b0ab078b91561eac1a0bcb169f17a.png";
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./redmanTopic.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./redmanTopic.scss");
...
Component.options.__file = "C:\\Users\\Administrator\\repository\\company\\amberOffice\\topic\\src\\components\\redmanTopicApp.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] redmanTopicApp.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-843b162a", Component.options)
  } else {
    hotAPI.reload("data-v-843b162a", Component.options)
  }
})()}
...
Component.options.__file = "C:\\Users\\Administrator\\repository\\company\\amberOffice\\topic\\src\\components\\redmanTopicDetail.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] redmanTopicDetail.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b6e63712", Component.options)
  } else {
    hotAPI.reload("data-v-b6e63712", Component.options)
  }
})()}
...
Component.options.__file = "C:\\Users\\Administrator\\repository\\company\\amberOffice\\topic\\src\\components\\redmanTopicList.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] redmanTopicList.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0ba5b9c4", Component.options)
  } else {
    hotAPI.reload("data-v-0ba5b9c4", Component.options)
  }
})()}
...
exports.default = {
    created: function created() {
        if (this.$router.history.current.path == '/') {
            this.$router.push({ path: '/redmanTopicList' });
        }
    }
};
...
var _vueAwesomeSwiper = __webpack_require__(170);

var _vueAwesomeSwiper2 = _interopRequireDefault(_vueAwesomeSwiper);

var _vue2Scrollbar = __webpack_require__(195);

var _vue2Scrollbar2 = _interopRequireDefault(_vue2Scrollbar);

var _vueLazyload = __webpack_require__(49);
...
exports.default = {
    data: function data() {
        return {
            ...
            isShowSwipe: 'none',
            isShowUserIcon: 'none',
            swiperPosition: 'absolute'
        };
    },
    computed: {
        expandValue: function expandValue() {
            if (this.expandBox.text == '展开全部') {
                return this.resData.userInfo.personalIntroduction.substr(0, 154) + '...';
            } else {
                return this.resData.userInfo.personalIntroduction;
            }
        },
        scrollBarWidth: function scrollBarWidth() {
            var len = this.resData.artPersonalImage.imageAccordingList.slice(0, 9).length;
            return len * 0.75 - 0.1;
        },
    ...
    created: function created() {
        this.getRedmanDetail();
    },
    methods: {
        //显示形象照大图
        showSwiper: function showSwiper(index) {
            this.$refs.myswiper.swiper.slideTo(index);
            this.isShowSwipe = 'block';
        },
        //展示全部
        expendAll: function expendAll() {
            if (this.expandBox.text == '展开全部') {
                this.expandBox.text = '收起';
            } else {
                this.expandBox.text = '展开全部';
            }
        },
        //返回
        ...
        //获取红人详情
        getRedmanDetail: function getRedmanDetail() {
            var _this = this;

            var url = _util2.default.baseUrl + '/api/artUserController/getPersonalInfo',
                options = {
                "deviceScreenWidth": "0",
                "pageOption": {
                    "itemCount": "1",
            ...
            _axios2.default.post(url, options).then(function (response) {
                if (response.data.status == 1) {
                    ...
                    _this.msg = '';
                    _this.setMobileFixed();
                } else {
                    _this.isRender = true;
                    _this.msg = response.data.error;
                }
        ...
        //设置移动端swiper为fixed
        setMobileFixed: function setMobileFixed() {
            if (!_util2.default.isPc()) {
                this.swiperPosition = 'fixed';
            }
        }
    },
    components: {
        swiper: _vueAwesomeSwiper2.default.swiper,
        swiperSlide: _vueAwesomeSwiper2.default.swiperSlide,
        VueScrollbar: _vue2Scrollbar2.default
    }
};
...
exports.default = {
    ...
    methods: {
        ...
        getTopicList: function getTopicList() {
            ...
            var url = _util2.default.baseUrl + '/api/artContentController/specialSubjectQuery',
                options = {
                "specialSubjectCode": _util2.default.getQueryString('subjectcode'),
                "zoo": {
                    "key": "tesetkey",
                    "token": ""
                }
            ...
            _axios2.default.post(url, options).then(function (response) {
                if (response.data.status == 1) {
                    ...
                    _this.msg = '';
                    setTimeout(function () {
                        window.scroll(0, window.fromPosition || 0);
                    }, 100);
                } else {
                    _this.isRender = true;
                    _this.msg = response.data.error;
        ...
        //跳转列表
        toRedmanTopicDetail: function toRedmanTopicDetail(userCode) {
            this.$router.push({ path: '/redmanTopicDetail?code=' + userCode });
        }
    }
};
...
var _redmanTopicList = __webpack_require__(101);

var _redmanTopicList2 = _interopRequireDefault(_redmanTopicList);

var _redmanTopicDetail = __webpack_require__(100);

var _redmanTopicDetail2 = _interopRequireDefault(_redmanTopicDetail);

var _redmanTopicApp = __webpack_require__(99);

var _redmanTopicApp2 = _interopRequireDefault(_redmanTopicApp);
...
var router = new _vueRouter2.default({
    routes: [{
        path: '/redmanTopicList',
        component: _redmanTopicList2.default
    }, {
        path: '/redmanTopicDetail',
        component: _redmanTopicDetail2.default
    }]
});

router.beforeEach(function (to, from, next) {
    next();
    if (from.path == '/redmanTopicList') {
        window.fromPosition = window.scrollY;
    }
    if (to.path == '/redmanTopicDetail') {
        window.scroll(0, 0);
    }
});

router.afterEach(function (route) {
    if (route.path == '/redmanTopicList') {
        document.title = '专题列表';
    } else if (route.path == '/redmanTopicDetail') {
        document.title = '专题详情';
    }
});
...
// module
exports.push([module.i, "body,\ndiv,\nspan,\napplet,\nobject,\niframe,\nh1,\nh2,\nh3,\nh4,\nh5,\nh6,\np,\nblockquote,\npre,\na,\nabbr,\nacronym,\naddress,\nbig,\ncite,\ncode,\ndel,\ndfn,\nem,\nimg,\nins,\nkbd,\nq,\ns,\nsamp,\nsmall,\nstrike,\nstrong,\nsub,\nsup,\ntt,\nvar,\nb,\nu,\ni,\ncenter,\ndl,\ndt,\ndd,\nol,\nul,\nli,\nfieldset,\nform,\nlabel,\nlegend,\ntable,\ncaption,\ntbody,\ntfoot,\nthead,\ntr,\nth,\ntd,\narticle,\naside,\ncanvas,\ndetails,\nembed,\nfigure,\nfigcaption,\nfooter,\nheader,\nhgroup,\nmenu,\nnav,\noutput,\nruby,\nsection,\nsummary,\ntime,\nmark,\naudio,\nvideo {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  font-size: .28rem;\n  font: inherit;\n  vertical-align: baseline; }\n\n/* HTML5 display-role reset for older browsers */\narticle,\naside,\ndetails,\nfigcaption,\nfigure,\nfooter,\nheader,\nhgroup,\nmenu,\nnav,\nsection {\n  display: block; }\n\nbody {\n  line-height: 1; }\n\nol,\nul {\n  list-style: none; }\n\nblockquote,\nq {\n  quotes: none; }\n\nblockquote:before,\nblockquote:after,\nq:before,\nq:after {\n  content: '';\n  content: none; }\n\ntable {\n  border-collapse: collapse;\n  border-spacing: 0; }\n\ndiv {\n  -webkit-tap-highlight-color: transparent; }\n\nbody {\n  height: 100%;\n  background: #F7F7F7; }\n\nimg {\n  width: 100%;\n  vertical-align: top; }\n\ndiv, p {\n  font-size: .14rem; }\n\n.tl {\n  text-align: left; }\n\n.pageleftshow-enter, .pageleftshow-leave-active {\n  transform: translate(-100%, 0); }\n\n.pageleftshow-enter-active, .pageleftshow-leave-active {\n  transition: transform .2s; }\n\n.pagerightshow-enter, .pagerightshow-leave-active {\n  transform: translate(100%, 0); }\n\n.pagerightshow-enter-active, .pagerightshow-leave-active {\n  transition: transform .2s; }\n\n.position-ab {\n  position: absolute;\n  width: 100%;\n  background: #fff; }\n\nhtml, body {\n  height: 100%;\n  position: relative; }\n\nbody {\n  background: #F2F2F2; }\n\n.clear-fix-w {\n  zoom: 1;\n  overflow: hidden; }\n\n.clear-fix-w:after {\n  content: '';\n  display: block;\n  clear: both;\n  height: 0;\n  overflow: hidden; }\n\n.tc {\n  text-align: center; }\n\n.topic-head-box {\n  width: 3.75rem;\n  height: 1.875rem;\n  position: relative;\n  overflow: hidden;\n  background: #F2F2F2; }\n\n.topic-head-bg, .topic-head-bg img, .topic-head-content, .redman-detail-head .redman-user-pic, .redman-detail-head-main {\n  width: 100%;\n  height: 100%; }\n\n.topic-head-bg, .redman-detail-head .redman-user-pic {\n  position: absolute;\n  left: 0;\n  top: 0;\n  -webkit-filter: blur(6px);\n  filter: blur(6px); }\n\n.redman-detail-head .redman-user-pic {\n  transform: translate(0, -10%);\n  height: auto; }\n\n.topic-head-content, .redman-detail-head-main {\n  position: relative;\n  background: rgba(0, 0, 0, 0.5);\n  color: #fff;\n  font-size: .12rem;\n  text-align: center; }\n\n.topic-head-content h2 {\n  font-size: .225rem;\n  padding: .75rem 0 .05rem 0; }\n\n.topic-list li {\n  margin: 0 0.15rem .1rem;\n  height: .7rem;\n  background: #fff;\n  border-radius: .04rem;\n  box-shadow: 0 0 4px 2px #e7e7e7;\n  position: relative; }\n\n.topic-list li:after {\n  content: '';\n  position: absolute;\n  display: inline-block;\n  width: .18rem;\n  height: .18rem;\n  background: url(" + __webpack_require__(149) + ") no-repeat;\n  background-size: contain;\n  right: .15rem;\n  top: .27rem; }\n\n.topic-list .redman-img, .redman-img-default {\n  float: left;\n  width: .7rem;\n  height: 100%;\n  border-right: .0005rem solid #e2e2e2;\n  margin-right: .15rem;\n  border-radius: .04rem 0 0 .04rem;\n  position: relative; }\n\n.topic-list .redman-img:after, .redman-img-default:after {\n  content: '';\n  display: inline-block;\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  left: 0;\n  top: 0;\n  background: rgba(0, 0, 0, 0.1);\n  border-radius: .04rem 0 0 .04rem; }\n\n.redman-detail-head-main .redman-img-default:after {\n  border-radius: 50%; }\n\n.redman-img-default {\n  background: url(" + __webpack_require__(139) + ");\n  background-size: contain; }\n\n.topic-list .redman-name {\n  display: block;\n  font-size: .16rem;\n  color: #555;\n  padding-top: .15rem; }\n\n.topic-list .redman-des {\n  display: block;\n  font-size: .13rem;\n  color: #9d9d9d;\n  margin-top: .1rem; }\n\n.topic-list .redman-des span {\n  display: inline-block;\n  margin-right: .01rem;\n  height: 0.2rem;\n  line-height: 0.2rem;\n  max-width: .7rem;\n  overflow: hidden; }\n\n.topic-list-box {\n  width: 3.75rem;\n  background: #F2F2F2;\n  padding-top: .15rem; }\n\n.redman-detail-head {\n  width: 3.75rem;\n  height: 2.25rem;\n  position: relative;\n  overflow: hidden; }\n\n.redman-detail-head-main {\n  background: rgba(0, 0, 0, 0.7); }\n\n.redman-user-small-pic {\n  width: .475rem;\n  height: .475rem;\n  border: .025rem solid #fff;\n  border-radius: 50%;\n  margin: .375rem 0 .1rem 0;\n  float: none;\n  display: inline-block; }\n\n.redman-user-name {\n  display: inline-block;\n  font-size: .14rem;\n  color: #fff;\n  max-width: 2.5rem;\n  height: .14rem;\n  overflow: hidden; }\n\n.redman-label-box {\n  margin: .15rem 0 .2rem; }\n\n.redman-label-box span {\n  display: inline-block;\n  font-size: .12rem;\n  padding: .025rem .05rem;\n  border: .005rem solid #CBA162;\n  color: #CBA162;\n  margin-right: .06rem;\n  border-radius: .02rem; }\n\n.redman-introduction {\n  font-size: .13rem;\n  color: #B0B0B0;\n  line-height: .18rem;\n  max-height: .36rem;\n  overflow: hidden;\n  max-width: 80%;\n  margin: 0 auto;\n  display: -webkit-box;\n  -webkit-box-orient: vertical;\n  -webkit-line-clamp: 2;\n  overflow: hidden; }\n\n.redman-user-sex {\n  display: inline-block;\n  width: .13rem;\n  height: .13rem;\n  background: url(" + __webpack_require__(151) + ");\n  background-size: contain; }\n\n.redman-user-woman {\n  background-image: url(" + __webpack_require__(155) + "); }\n\n.redman-detail-item {\n  width: 3.45rem;\n  padding: 0 .15rem;\n  background: #fff;\n  margin-bottom: .1rem;\n  border-bottom: .005rem solid #fff; }\n\n.redman-detail-item h3 {\n  line-height: .39rem;\n  border-bottom: .005rem solid #F3F3F3;\n  color: #333; }\n\n.redman-shape-list, .redman-influence-list {\n  padding-bottom: .2rem; }\n\n.redman-shape-list li {\n  margin-top: .25rem;\n  font-size: .14rem;\n  color: #555; }\n\n.redman-shape-list .shape-tit {\n  display: inline-block;\n  width: 1rem; }\n\n.shape-pic-box {\n  max-width: 3.6rem;\n  overflow: hidden; }\n\n.shape-pic-box dl {\n  max-height: .8rem;\n  overflow: hidden; }\n\n.shape-pic-box dd {\n  float: left;\n  width: .65rem;\n  height: .65rem;\n  margin: .15rem .1rem 0 0; }\n\n.shape-pic-box dd:last-child {\n  margin-right: 0; }\n\n.shape-pic-box img {\n  width: 100%;\n  height: 100%; }\n\n.redman-short-des {\n  margin: .2rem 0;\n  font-size: .13rem;\n  line-height: .21rem;\n  color: #C1C1C1;\n  word-break: break-all;\n  /*display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:6;overflow:hidden;*/ }\n\n.redman-show-more {\n  height: .4rem;\n  line-height: .4rem;\n  text-align: center;\n  border-top: .005rem dashed #E2E2E2;\n  background: #F9F9F9;\n  margin: 0 -.15rem; }\n\n.redman-show-more:after {\n  content: '';\n  display: inline-block;\n  width: .09rem;\n  height: .05rem;\n  background: url(" + __webpack_require__(147) + ");\n  background-size: contain;\n  margin-left: .05rem;\n  vertical-align: .02rem; }\n\n.redman-show-all:after {\n  background-image: url(" + __webpack_require__(150) + "); }\n\n.redman-influence-list li {\n  margin-top: .225rem;\n  font-size: .14rem; }\n\n.redman-influence-list .influence-tit {\n  float: left; }\n\n.redman-influence-list .influence-value {\n  float: right; }\n\n.influence-huajiao:before, .influence-instagram:before, .influence-meipai:before, .influence-miaopai:before, .influence-xinlang:before, .influence-yingke:before, .influence-weixin:before {\n  content: '';\n  display: inline-block;\n  width: .18rem;\n  height: .18rem;\n  background-size: contain;\n  vertical-align: middle;\n  margin-right: .05rem; }\n\n.influence-huajiao:before {\n  background-image: url(" + __webpack_require__(157) + "); }\n\n.influence-instagram:before {\n  background-image: url(" + __webpack_require__(158) + "); }\n\n.influence-meipai:before {\n  background-image: url(" + __webpack_require__(159) + "); }\n\n.influence-miaopai:before {\n  background-image: url(" + __webpack_require__(160) + "); }\n\n.influence-xinlang:before {\n  background-image: url(" + __webpack_require__(162) + "); }\n\n.influence-yingke:before {\n  background-image: url(" + __webpack_require__(163) + "); }\n\n.influence-weixin:before {\n  background-image: url(" + __webpack_require__(161) + "); }\n\n.icon-back {\n  position: absolute;\n  left: .1rem;\n  top: .1rem;\n  width: .35rem;\n  height: .35rem;\n  background: rgba(0, 0, 0, 0.3);\n  z-index: 1;\n  text-align: center;\n  border-radius: 50%; }\n\n.icon-back:after {\n  content: '';\n  display: inline-block;\n  width: .08rem;\n  height: .165rem;\n  background: url(" + __webpack_require__(148) + ") no-repeat;\n  background-size: contain;\n  margin-top: .09rem; }\n\n.render-list-bg {\n  background: url(" + __webpack_require__(68) + ") no-repeat;\n  background-size: contain;\n  height: 100%; }\n\n.render-detail-bg {\n  background: url(" + __webpack_require__(145) + ") no-repeat;\n  background-size: contain; }\n", ""]);
...
// module
exports.push([module.i, "\n.swiper-container[data-v-b6e63712] {\n    position:absolute;\n    left:0;\n    top:0;\n    background:url(" + __webpack_require__(166) + ") no-repeat center center rgba(0,0,0,0.8);\n    width: 100%;\n    height: 100%;\n}\n.swiper-slide[data-v-b6e63712] {\n    text-align: center;\n    font-size: 18px;\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: -webkit-flex;\n    display: flex;\n    -webkit-box-pack: center;\n    -ms-flex-pack: center;\n    -webkit-justify-content: center;\n    justify-content: center;\n    -webkit-box-align: center;\n    -ms-flex-align: center;\n    -webkit-align-items: center;\n    align-items: center;\n}\n", ""]);
...
module.exports = __webpack_require__.p + "assets/upload-default-pic-cd7d1a3f734a4d76ecff49dd89993dd1.jpg";
...
module.exports = __webpack_require__.p + "assets/detail-bg-2x-036e46493655b700f902d9257c1d0099.png";
...
module.exports = __webpack_require__.p + "assets/icon-arrow-down-2x-3505403fbb8135944fe155800a7fb711.png";

/***/ }),
/* 148 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "assets/icon-arrow-left-2x-123cd565b027108ba3ba9aa19edadcc6.png";

/***/ }),
/* 149 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "assets/icon-arrow-right-2x-04bff106bc276f32d2df7c544440297b.png";

/***/ }),
/* 150 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "assets/icon-arrow-up-2x-c3b149e5671f930dd9eee8a53cc6ca8c.png";

/***/ }),
/* 151 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "assets/icon-man-2x-d405a03c7f51b3ac0542c8f22833ea00.png";
...
module.exports = __webpack_require__.p + "assets/icon-women-2x-85f110be0831349552ed8b5e75ae9326.png";
...
module.exports = __webpack_require__.p + "assets/icon_huajiao@2x-48b1b769d10522db7d928500b0bb7e93.png";

/***/ }),
/* 158 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "assets/icon_instagram@2x-d378bb3d814fa5b237f534e9970888a6.png";

/***/ }),
/* 159 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "assets/icon_meipai@2x-7cf6eaa06f4ecca98ef933323f39e976.png";

/***/ }),
/* 160 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "assets/icon_miaopai@2x-ceaef4facd99467e8d67e9d05d74351a.png";

/***/ }),
/* 161 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "assets/icon_weixin@2x-89f06e0c7ae8cd97eec5a62c53a2dc4c.png";

/***/ }),
/* 162 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "assets/icon_xinlang@2x-b77492d5b6d70bb5dadd02aa0d7fffdd.png";

/***/ }),
/* 163 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "assets/icon_yingke@2x-37c8f309d7cbc82769dd78c5f9740c80.png";
...
module.exports = __webpack_require__.p + "assets/loading-a248117e9bf15a3d90e732c6c2e232a4.gif";
...
var SwiperComponent = __webpack_require__(172)
var SlideComponent = __webpack_require__(171)
...
Component.options.__file = "C:\\Users\\Administrator\\repository\\company\\amberOffice\\topic\\node_modules\\vue-awesome-swiper\\slide.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4aefc8dc", Component.options)
  } else {
    hotAPI.reload("data-v-4aefc8dc", Component.options)
  }
})()}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-53d46c67", Component.options)
  } else {
    hotAPI.reload("data-v-53d46c67", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('transition', {
    ...
    staticClass: "render-list-bg",
    domProps: {
      "textContent": _vm._s(_vm.msg)
    }
  }) : _c('div', {
    staticClass: "position-ab",
    staticStyle: {
      "background": "none"
    }
  }, [_c('router-view'), _vm._v(" "), _c('div', {
    staticClass: "topic-head-box"
  }, [_c('div', {
    staticClass: "topic-head-bg"
  }, [_c('img', {
    directives: [{
      name: "lazy",
      rawName: "v-lazy",
      value: (_vm.resData.artSpecialSubject.imageUrl),
      expression: "resData.artSpecialSubject.imageUrl"
    }],
    staticClass: "topic-head-bg-img"
  })]), _vm._v(" "), _c('div', {
    staticClass: "topic-head-content"
  }, [_c('h2', {
    domProps: {
      "textContent": _vm._s(_vm.resData.artSpecialSubject.mainTitle.substr(0, 10))
    }
  }), _vm._v(" "), _c('p', {
    domProps: {
      "textContent": _vm._s(_vm.resData.artSpecialSubject.subTitle.substr(0, 20))
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "topic-list-box"
  }, [_c('ul', {
    staticClass: "topic-list"
  }, _vm._l((_vm.resData.userInfoList), function(item, index) {
    return _c('li', {
      on: {
        "click": function($event) {
          _vm.toRedmanTopicDetail(item.userCode)
        }
      }
    }, [_c('span', {
      staticClass: "redman-img-default"
    }, [(item.userIconurl) ? _c('img', {
      directives: [{
        name: "lazy",
        rawName: "v-lazy",
        value: (item.userIconurl),
        expression: "item.userIconurl"
      }],
      staticClass: "redman-img"
    }) : _vm._e()]), _vm._v(" "), (item.userName === '') ? _c('span', {
      staticClass: "redman-name",
      domProps: {
        "textContent": _vm._s(item.userPhone.replace(/(\d{3})(\d{4})(\d{4})/g, '$1****$3'))
      }
    }) : _c('span', {
      staticClass: "redman-name",
      domProps: {
      ...
      staticClass: "redman-des"
    }, _vm._l((item.domainLabelList.slice(0, 3)), function(labelItem, labelIndex) {
      return _c('span', [_vm._v(_vm._s(labelItem))])
    }))])
  }))])], 1)])
},staticRenderFns: []}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0ba5b9c4", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-4aefc8dc", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-53d46c67", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-843b162a", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('transition', {
    ...
    staticClass: "redman-detail-head"
  }, [_c('span', {
    staticClass: "icon-back",
    on: {
      "click": _vm.backToList
    }
  }), _vm._v(" "), (_vm.resData.userInfo.userIconThumburl) ? _c('img', {
    directives: [{
      name: "lazy",
      rawName: "v-lazy",
      value: (_vm.resData.userInfo.userIconThumburl),
      expression: "resData.userInfo.userIconThumburl"
    }],
    staticClass: "redman-user-pic",
    attrs: {
      "data-big": _vm.resData.userInfo.userIconurl
    }
  }) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "redman-detail-head-main"
  }, [(_vm.resData.userInfo.userIconThumburl) ? _c('img', {
    directives: [{
      name: "lazy",
      rawName: "v-lazy",
      value: (_vm.resData.userInfo.userIconThumburl),
    ...
    staticClass: "redman-user-small-pic",
    attrs: {
      "data-big": _vm.resData.userInfo.userIconurl
    },
    on: {
      "click": function($event) {
        _vm.isShowUserIcon = 'block'
      }
    }
  }) : _c('span', {
    staticClass: "redman-img-default redman-user-small-pic"
  }), _vm._v(" "), _c('p', {
    staticClass: "tc"
  }, [_c('span', {
    staticClass: "redman-user-name",
    domProps: {
      "textContent": _vm._s(_vm.resData.userInfo.userName)
    }
  }), _vm._v(" "), (_vm.resData.userInfo.sex == 'dzsd4029100100030001') ? _c('span', {
    staticClass: "redman-user-sex redman-user-man"
  }) : (_vm.resData.userInfo.sex == 'dzsd4029100100030002') ? _c('span', {
    staticClass: "redman-user-sex redman-user-woman"
  }) : _vm._e()]), _vm._v(" "), _c('p', {
    staticClass: "redman-label-box"
  }, _vm._l((_vm.resData.userInfo.domainLabelList.slice(0, 3)), function(item, index) {
    return _c('span', {
      domProps: {
    ...
    staticClass: "redman-introduction",
    domProps: {
      "textContent": _vm._s(_vm.resData.userInfo.userIntroduction)
    }
  })])]), _vm._v(" "), (_vm.resData.artPersonalImage) ? _c('div', {
    staticClass: "redman-detail-item"
  }, [_c('h3', [_vm._v("个人形象")]), _vm._v(" "), _c('ul', {
    staticClass: "redman-shape-list"
  }, [(_vm.resData.artPersonalImage.userHeight) ? _c('li', [_c('span', {
    staticClass: "shape-tit"
  }, [_vm._v("身高/cm：")]), _c('span', {
    staticClass: "shape-value",
    domProps: {
      "textContent": _vm._s(_vm.resData.artPersonalImage.userHeight)
    }
  })]) : _vm._e(), _vm._v(" "), (_vm.resData.artPersonalImage.userWeight) ? _c('li', [_c('span', {
    staticClass: "shape-tit"
  }, [_vm._v("体重/kg：")]), _c('span', {
    staticClass: "shape-value",
    domProps: {
      "textContent": _vm._s(_vm.resData.artPersonalImage.userWeight)
    }
  })]) : _vm._e(), _vm._v(" "), (_vm.resData.artPersonalImage.userBust) ? _c('li', [_c('span', {
    staticClass: "shape-tit"
  }, [_vm._v("三围/cm：")]), _c('span', {
    staticClass: "shape-value"
  }, [(_vm.resData.artPersonalImage.userBust) ? _c('span', [_vm._v(_vm._s(_vm.resData.artPersonalImage.userBust))]) : _c('span', [_vm._v("保密")]), _vm._v(" / "), (_vm.resData.artPersonalImage.userHipline) ? _c('span', [_vm._v(_vm._s(_vm.resData.artPersonalImage.userHipline))]) : _c('span', [_vm._v("保密")]), _vm._v(" / "), (_vm.resData.artPersonalImage.userTheWaist) ? _c('span', [_vm._v(_vm._s(_vm.resData.artPersonalImage.userTheWaist))]) : _c('span', [_vm._v("保密")])])]) : _vm._e(), _vm._v(" "), (_vm.resData.artPersonalImage.imageAccordingList.length) ? _c('li', [_c('span', {
    staticClass: "shape-tit"
  }, [_vm._v("形象照：")]), _vm._v(" "), _c('div', [(_vm.resData.artPersonalImage.imageAccordingList.length < 5) ? _c('div', {
    staticClass: "shape-pic-box"
  }, [_c('dl', {
    staticClass: "clear-fix-w",
    style: ({
      width: _vm.scrollBarWidth + 'rem'
    })
  }, _vm._l((_vm.resData.artPersonalImage.imageAccordingList.slice(0, 9)), function(item, index) {
    return _c('dd', {
      on: {
        "click": function($event) {
          _vm.showSwiper(index)
        }
      }
    }, [_c('img', {
      directives: [{
        name: "lazy",
        rawName: "v-lazy",
        value: (_vm.resData.artPersonalImage.imageAccordingList[0].thumbPicUrl),
        expression: "resData.artPersonalImage.imageAccordingList[0].thumbPicUrl"
      }],
      attrs: {
        "data-big": _vm.resData.artPersonalImage.imageAccordingList[0].picUrl,
  ...
  }))])], 1)]) : _vm._e()])]) : _vm._e(), _vm._v(" "), (_vm.resData.userInfo.personalIntroduction) ? _c('div', {
    staticClass: "redman-detail-item"
  }, [_c('h3', [_vm._v("个人介绍")]), _vm._v(" "), _c('div', {
    staticClass: "redman-short-des",
    domProps: {
      "textContent": _vm._s(_vm.expandValue)
    }
  }), _vm._v(" "), (_vm.resData.userInfo.personalIntroduction.length > 154) ? _c('p', {
    staticClass: "redman-show-more",
    class: _vm.expandBox.className,
    on: {
      "click": _vm.expendAll
    }
  }, [_vm._v(_vm._s(_vm.expandBox.text))]) : _vm._e()]) : _vm._e(), _vm._v(" "), (_vm.resData.socialMediaList.length) ? _c('div', {
    staticClass: "redman-detail-item"
  }, [_c('h3', [_vm._v("影响力")]), _vm._v(" "), _c('ul', {
    staticClass: "redman-influence-list"
  }, _vm._l((_vm.resData.socialMediaList), function(item, index) {
    return _c('li', {
      staticClass: "clear-fix-w"
    }, [_c('span', {
      staticClass: "influence-tit influence-xinlang",
      domProps: {
        "textContent": _vm._s(item.platformId.substr(0, 15))
      }
    }), (item.fansCount) ? _c('span', {
      staticClass: "influence-value"
    }, [_vm._v("粉丝：" + _vm._s(item.fansCount))]) : _vm._e()])
  }))]) : _vm._e(), _vm._v(" "), (_vm.resData.artPersonalImage && _vm.resData.artPersonalImage.imageAccordingList) ? _c('div', {
    staticStyle: {
      "max-width": "3.75rem"
    },
    style: ({
      display: _vm.isShowSwipe
    }),
    on: {
      "click": function($event) {
        _vm.isShowSwipe = 'none'
      }
    }
  }, [_c('swiper', {
    ref: "myswiper",
    ...
    return _c('swiper-slide', {
      ...
      directives: [{
        name: "lazy",
        rawName: "v-lazy",
        value: (_vm.resData.artPersonalImage.imageAccordingList[0].picUrl),
        expression: "resData.artPersonalImage.imageAccordingList[0].picUrl"
      }],
      attrs: {
        "onerror": "this.parentNode.removeChild(this)"
      },
    ...
    slot: "pagination"
  })], 2)], 1) : _vm._e(), _vm._v(" "), (_vm.resData.userInfo && _vm.resData.userInfo.userIconurl) ? _c('div', {
    staticStyle: {
      "max-width": "3.75rem"
    },
    style: ({
      display: _vm.isShowUserIcon
    }),
    on: {
      "click": function($event) {
        _vm.isShowUserIcon = 'none'
      }
    }
  }, [_c('swiper', {
    style: ({
    ...
    directives: [{
      name: "lazy",
      rawName: "v-lazy",
      value: (_vm.resData.userInfo.userIconurl),
      expression: "resData.userInfo.userIconurl"
    }],
    attrs: {
      "onerror": "this.parentNode.removeChild(this)"
    },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-b6e63712", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(193)("67896cb1", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-b6e63712\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./redmanTopicDetail.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-b6e63712\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./redmanTopicDetail.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
